import { watch, setLet, html, tag, setProp } from "taggedjs";
import { renderCountDiv } from "./renderCount.component";
export const propsDebugMain = tag(() => {
    let renderCount = setLet(0)(x => [renderCount, renderCount = x]);
    let propsJson = setLet({ test: 33, x: 'y' })(x => [propsJson, propsJson = x]);
    let propNumber = setLet(0)(x => [propNumber, propNumber = x]);
