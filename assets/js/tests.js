...
export async function runTests() {
    it('elements exists', () => {
        expectElementCount('#gateway-test-prop-display', 1);
        expectHTML('#gateway-test-prop-display', '22');
        expectMatchedHtml('#gateway-test-prop-display', '#display-gateway-count');
    });
    it('counters increase', async () => {
        ...
        expectMatchedHtml('#display-gateway-count', '#gateway-test-prop-display');
    });
    try {
        await execute();
